...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Proximus IT');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'deividy@gmail.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
