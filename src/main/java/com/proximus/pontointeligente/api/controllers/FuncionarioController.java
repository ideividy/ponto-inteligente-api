...
import com.proximus.pontointeligente.api.dtos.FuncionarioDto;
...
public class FuncionarioController {
	...
	public ResponseEntity<Response<FuncionarioDto>>atualizar(@PathVariable("id") Long id, @Valid @RequestBody FuncionarioDto funcionarioDto, BindingResult result)throws NoSuchAlgorithmException{
		...
		if(result.hasErrors()) {
			log.error("Erro validando funcionário: ", id);
	...
	private FuncionarioDto converterFuncionarioDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasTrabalhadoDiaOpt().ifPresent(qtdHorasTrabalhoDia -> funcionarioDto.setQtdHorasTrabalhoDia(Optional.of(Float.toString(qtdHorasTrabalhoDia))));
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	private void atualizarDadosFuncionario(Funcionario funcionario, @Valid FuncionarioDto funcionarioDto, BindingResult result) throws NoSuchAlgorithmException{
		...
		funcionario.setQtdHorasTrabalhadoDia(null);
		funcionarioDto.getQtdHorasTrabalhoDia().ifPresent(qtdHorasTrabalhoDia -> funcionario.setQtdHorasTrabalhadoDia(Float.valueOf(qtdHorasTrabalhoDia)));
