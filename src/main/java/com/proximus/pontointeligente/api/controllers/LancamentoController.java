...
import com.proximus.pontointeligente.api.dtos.LancamentoDto;
...
import com.proximus.pontointeligente.api.services.LancamentoService;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
		...
		PageRequest pageRequest = PageRequest.of(pag, this.qtdPorPagina, Direction.valueOf(dir), ord);//new PageRequest(pag, this.qtdPorPagina, Direction.valueOf(dir), ord);
	...
	public ResponseEntity<Response<LancamentoDto>> adicionar(@Valid @RequestBody LancamentoDto lancamentoDto, BindingResult result)throws ParseException{
		...
		log.info("Adicionando elemento: {}", lancamentoDto.toString());
	...
	/**
	 * Converte o DTO para o respectivo lançamento
	 * 
	 * @param lancamentoDto
	 * @param result
	 * @return Lancamento
	 ...
	 */
	private Lancamento converterDtoParaLancamento(@Valid LancamentoDto lancamentoDto, BindingResult result) throws java.text.ParseException {
	...
	private void validarFuncionario(@Valid LancamentoDto lancamentoDto, BindingResult result) {
		if(lancamentoDto.getFuncionarioId() == null) {
			result.addError(new ObjectError("funcionarioId", "Funcionário não informado"));
			return;
		}
		log.info("Validando funcionário ID: ", lancamentoDto.getFuncionarioId());
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorId(lancamentoDto.getFuncionarioId());
		if(!funcionario.isPresent()) {
			result.addError(new ObjectError("funcionarioId", "Funcionário não encontrado. ID inexistente"));
		}
	}
